...
public class WebRequestArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) {
        if (parameter.getParameterType().equals(com.example.api.security.resolver.WebRequest.class)) {
...
//            SessionDevice sessionDevice = (SessionDevice) request.getAttribute("sessionDevice");
            ...
            return new com.example.api.security.resolver.WebRequest(request, clientMap);
        }
        return null;
    }
